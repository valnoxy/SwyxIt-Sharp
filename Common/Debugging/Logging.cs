...
*
* Notes:
*      Backported from: https://git.idyllic.dev/valnoxy/xorieos/-/blob/main/eos25/base/ntsetup/winnt32/modernsetup/common/logging.cs
*/
...
namespace SwyxSharp.Common.Debugging
{
